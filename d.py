...
bot = telebot.TeleBot('7220640211:AAFUxlh5nBg-415uurjpVbUl6qHeR_dx6Bc')

# Admin user IDs
admin_id = ['1895138738','1670537997','1131669405']
...
def create_user_keyboard():
    ...
    button1 = KeyboardButton("⚔️ START BAD BOY ATTACK ⚔️")
...
def handle_user_buttons(message):
    ...
    if user_id in allowed_user_ids:
        if message.text == "⚔️ START BAD BOY ATTACK ⚔️":
            handle_bgmi(message)
